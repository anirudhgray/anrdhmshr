...
function App () {
  ...
  return (
    <div className="App">
      {/* <img src={me} /> */}
      <div className="line-drawing-demo h-screen w-screen flex flex-col items-center justify-center gap-3">
        ...
        <div className="sm:mt-8 mt-5 sm:text-2xl text-3xl flex flex-row justify-center md:gap-4 gap-6">
          <a target={"_blank"} referrerPolicy="no-referrer" href={"https://github.com/anirudhgray"}>
            <AiOutlineGithub />
          </a>
          <a target={"_blank"} referrerPolicy="no-referrer" href={"https://www.linkedin.com/in/anirudh-mishra/"}>
            <AiOutlineLinkedin />
          </a>
          <a target={"_blank"} referrerPolicy="no-referrer" href={" mailto:anirudh04mishra@gmail.com"}>
            <AiOutlineMail />
          </a>
          <a target={"_blank"} referrerPolicy="no-referrer" href={"https://drive.google.com/file/d/1fpS8gIELzxlp4ncQnO6V-_9z8VGuIZis/view?usp=sharing"}>
            <AiFillFileText />
          </a>
        </div>
      </div>
